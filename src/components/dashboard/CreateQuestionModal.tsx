...
export const CreateQuestionModal: React.FC<CreateQuestionModalProps> = ({ isOpen, onClose, onSuccess, topicId }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If topicId is provided, link the question to the topic
      if (topicId) {
        await fetchWithAuth(`/api/topics/${topicId}/questions`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            questionId: newQuestion.id,
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Create New Question">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setAnswers([]); // Reset answers when type changes
            }}
          >
